...
public class NMSpatialCSDialog  extends JDialog implements ActionListener {
	...
	private KeepVariableListWidget contPanel;
        ...
        protected JScrollPane spScroller;
        protected JList spList;
        protected JPanel nbPanel;
        protected JScrollPane nbScroller;
	...
	private static NMSpatialCSDialog  theDialog;
	...
	public static void runit() {
		if(theDialog == null){
			theDialog = new NMSpatialCSDialog();
	...
	public static void runitagain(GMModel mod) {
		if(theDialog == null){
			theDialog = new NMSpatialCSDialog(mod);
		}
	...
	public NMSpatialCSDialog(JFrame frame) {
		super(frame);
		widgets = new Vector();
		initGUI();
                resetModel();
	...
	public NMSpatialCSDialog(GMModel mod) {
		super();
		...
		try {
...

			{
				...
				weightPanel.setPreferredSize(new java.awt.Dimension(223, 52));
					...
					getContentPane().add(listwButton, new AnchorConstraint(631, 580, 661, 440,
							AnchorConstraint.ANCHOR_REL, AnchorConstraint.ANCHOR_REL, 
							AnchorConstraint.ANCHOR_REL, AnchorConstraint.ANCHOR_REL));
	...
	public void updateModel(){
                    ...
                    model.efeglmextra.spdfForModel = model.data.replace("__","");
	...
	private void completed(){
		...
		if(!valid())
			return;
                ...
                NMSpatialCSExplorer exp = new NMSpatialCSExplorer(model,false);
